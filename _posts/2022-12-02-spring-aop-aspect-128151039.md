---
layout: post
title: "Spring AOP aspect切面指北"
date: 2022-12-02 17:03:55 +0800
author: gaoxingliang
description: "spring aspect切面基础写法和示例"
categories:
  - 迁移自CSDN
tags:
  - "spring"
  - "java"
  - "后端"
csdn_url: "https://blog.csdn.net/scugxl/article/details/128151039"
---

#### 文章目录

- [Spring Aspect cheatsheet](#Spring_Aspect_cheatsheet_1)
- [使用](#_4)
- [Why？](#Why_9)
- - [概念](#_12)
  - - [Advice类型](#Advice_33)
  - [PointCut常用示例](#PointCut_42)
  - - [Advice使用示例](#Advice_64)
    - [一个完整的例子](#_124)
- [参考](#_168)
...
完整代码：[spring-aop](https://github.com/gaoxingliang/helloworlds/tree/master/spring-aop)

1. 引入库， 参考[build.gradle](https://github.com/gaoxingliang/helloworlds/tree/master/spring-aop/build.gradle)
2. 使用`@Aspect`和`@Configuration`来标记Aspect。参考[LogingAspect](https://github.com/gaoxingliang/helloworlds/tree/master/spring-aop/src/main/java/com/example/springaop/LogingAspect.java)
