...
date: 2014-07-07 20:24:03 +0800
author: gaoxingliang
description: "自旋锁（Spin lock）自旋锁是指当一个线程尝试获取某个锁时，如果该锁已被其他线程占用，就一直循环检测锁是否被释放，而不是进入线程挂起或睡眠状态。自旋锁适用于锁保护的临界区很小的情况，临界区很小的话，锁占用的时间就很短。简单的实现import java.util.concurrent.atomic.AtomicReference;public class Spi"
categories:
  - 迁移自CSDN
tags:
  - "java"
  - "锁"
csdn_url: "https://blog.csdn.net/scugxl/article/details/37532991"
---
...
下图是CLH锁和MCS锁队列图示：  
![CLH-MCS-SpinLock]({{ '/assets/images/posts/mcs-clh-37532991/img-001.png' | relative_url }})
...
原文：http://coderbee.net/index.php/concurrent/20131115/577/comment-page-1
